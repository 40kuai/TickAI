"""Tests for hermes.i18n — flat-key translations + enum label helpers."""
import os
import unittest
...
from hermes.i18n import strings as i18n  # noqa: E402


class TranslationTests(unittest.TestCase):
    def test_t_zh_returns_chinese(self):
        self.assertIn("Hermes", i18n.t("home_title", lang="zh"))

    def test_t_en_returns_english(self):
        self.assertIn("Hermes", i18n.t("home_title", lang="en"))

    def test_t_falls_back_to_zh_for_unknown_lang(self):
        self.assertEqual(i18n.t("home_title", lang="xx"), i18n.t("home_title", lang="zh"))

    def test_t_returns_key_if_missing(self):
        # Missing key in both languages → returns the key itself
        self.assertEqual(i18n.t("totally.nonexistent", lang="zh"), "totally.nonexistent")
        self.assertEqual(i18n.t("totally.nonexistent", lang="en"), "totally.nonexistent")

    def test_t_substitutes_kwargs(self):
        out = i18n.t("servers_executing", lang="zh", name="web-01")
    ...
    def test_t_kwargs_missing_does_not_crash(self):
        ...
        out = i18n.t("servers_executing", lang="zh")  # missing 'name'
